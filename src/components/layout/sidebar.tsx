...
import { getNavigationsByRole } from "@/data/dynamic-navigations"
...
export function Sidebar({ dictionary }: { dictionary: DictionaryType }) {
  ...
  // Combiner les navigations par défaut avec les navigations spécifiques au rôle
  const roleBasedNavigations = getNavigationsByRole(
    currentRole as UserRole,
    isOrgAdmin,
    isSuperAdmin
  )
  const allNavigationsData = [...navigationsData, ...roleBasedNavigations]
