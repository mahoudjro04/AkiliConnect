            ...
            <div className="flex flex-1 flex-col space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-1 gap-2">
                  <Button
                    variant={
                      settings.theme === "blue" ? "secondary" : "default"
                    }
                    style={
                      {
                        "--primary":
                          themes.blue.activeColor[
                            settings.mode === "dark" ? "dark" : "light"
                          ],
                        "--primary-foreground":
                          themes.blue.activeColor["foreground"],
                      } as CSSProperties
                    }
                    onClick={() =>
                      updateSettings({
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-1 gap-2">
                  <Button
                    variant={settings.radius === 0.25 ? "secondary" : "outline"}
                    onClick={() => {
                      updateSettings({
                        ...settings,
                        radius: 0.25,
